# Rep5x - Universal bill of materials
...
|------|-----|-------------|------|-------------|-------|
| 1 | 2 | Nema17 stepper motor | Motor | Stepper motors for A and B axis | Standard 42mm body |
| 2 | 2 | GT2 20T 5mm bore | Drive | Drive pulleys for A and B axis | 20 teeth, 5mm bore |
| 3 | 1 | GT2 timing belt 6x188mm | Drive | Drive belt for A-axis | 6mm wide, 188mm length |
| 4 | 1 | GT2 timing belt 6x158mm | Drive | Drive belt for B-axis | 6mm wide, 158mm length |
| 5 | 2 | 608 2RS bearing DIN625 | Bearing | Ball bearings for B-axis rotation | Standard skateboard bearings |
| 6 | 2 | 61804 bearing | Bearing | Thin section bearing for carriage mount | For A-axis rotation |
| 7 | 1 | Microswitch | Sensor | Endstop switch for B-axis | 2-pin micro limit switch |
| 8 | 1 | Optical sensor | Sensor | A-axis homing sensor | 3-pin optical endstop sensor |
| 9 | 1 | Control board | Electronics | 6+ stepper driver board | See tested control boards section - BTT Octopus V1.1 tested |
| 10 | 6 | TMC2208 | Electronics | Stepper drivers | UART mode, for all 6 axes |
| 11 | 1 | MST-005-12A slipring | Electrical | Slipring assembly | 12 channels, 2A each, 5mm bore |
| 12 | 1 | Wire/cables | Electrical | Connection wires | For slip ring and stepper connections |
| 13 | 1 | JST connectors (optional) | Electrical | Removable connectors | For easy maintenance |
...
- **Assembly guide**: See [assembly guide](../../assembly-guide.md) for complete build instructions
